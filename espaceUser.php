...
<html>
   <head>
      ...
      <script type="text/javascript" src="js/jsAction/controleG.js"></script> 
   </head>
   <body>
      <div id="wrapper">
                           ...
                           <div class="modal inmodal" id="myModalSupp" tabindex="-1" role="dialog" aria-hidden="true">
                              ...
                              <div class="modal-dialog">
                                 <div class="modal-content animated flipInY">
                                    <div class="modal-header">
                                       <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                       <h4 class="modal-title"><span class="text-primary" id="forModifText">Réservez cette période !</span></h4>
                                    </div>
                                    <div class="modal-body">
                                               <label class="font-noraml">Sélectionner la date :</label>
                                               <small class="text-muted">(La date sélectionnée doit être correspond au jour du réservation)</small>
                           <div class="form-group" id="data_1">
                              <div class="input-group date">
                                 <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input onkeyup="format(this)" placeholder="YYYY-MM-DD" type="text" class="form-control" id="datePute" value="">
                              </div>
                           </div>
      ...
      <!-- JSKnob -->
      <span id="mettez"></span>
      <input type="hidden" id="forM" value="aqdv"></input>
