...
<nav class="navbar-default navbar-static-side fixed-menu" role="navigation">
               ...
               <ul class="nav metismenu" id="side-menu">
                  ...
                  <li>
                     ...
                     <div class="leftpanel-userinfo collapse" id="loguserinfo" style="position: absolute; background: #3b4354!important">
                        ...
                        <h5 class="sidebar-title">Departement</h5>
                        <address>
                           <?php //echo $_SESSION['departement'];?>
                        </address>
                        <?php } ?>
                        ...
                        <?php if($_SESSION['type']=='prof'){ ?>
                           ...
                           <li class="list-group-item">
                              ...
                              <span class="pull-right"><?php if($_SESSION['type']=='prof') echo $_SESSION['telephone'];?></span>
                           </li>
                       <?php } ?>
         ...
         <div id="<?php  if($_SESSION['type']=='admin') { echo 'page-wrapper';} ?>" class="gray-bg">
            <div>
               <nav class="navbar navbar-fixed-top white-bg <?php  if($_SESSION['type']=='admin') { echo 'show-menu-full';} ?> " id="nav" role="navigation" style="margin-bottom: 0">
               <?php  if($_SESSION['type']=='admin') { ?>
